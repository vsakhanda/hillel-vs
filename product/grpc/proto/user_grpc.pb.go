...
func (c *userServiceClient) RegisterUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) RegisterUser(context.Context, *User) (*UserResponse, error) {
